...
public class User  implements java.io.Serializable {
    ...
    public User(String name, String email, String password, String address, Date regDate, double balance, String image, String phone, String role, Boolean emailVerified, Boolean deleted, Set<Product> products, Set<SoldItem> soldItems, Set<Order> orders, Set<Review> reviews, Set<CartItem> cartItems) {
        this.name = name;
        this.email = email;
        this.password = password;
        this.address = address;
