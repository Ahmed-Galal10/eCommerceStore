...
//        cartItem.setQuantity(5);
    ...
    void testUpdateCartItem() {
        ...
        CartItemDto expected = getCartItemDto(1, 1002, 2.0, "sugar");

        CartItem item = getCartItem(1, 2, 1222);

        CartItemRequest request = getCartItemRequest(1, 2, 1002);
    ...
    void testAddCartItem() {
        ...
        CartItemDto expected = getCartItemDto(1, 500, 2.0, "sugar");
